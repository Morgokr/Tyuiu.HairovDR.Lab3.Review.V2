...
namespace Tyuiu.HairovDR.Lab3.Review
{
    public class MenuPage : IPage
    {
        ...
        public void ReadTyped(string value)
        {
        ...
        private void RenderHead()
        {
            ...
            //4 строка
            Console.Write("║");
            for (int i = 0; i < (120 - 2 - "Выполнил Хаиров Даниэль Равильевич".Length) / 2; i++)
            {
                Console.Write(" ");
            }
            Console.Write("Выполнил Хаиров Даниэль Равильевич");
            for (int i = 0; i < (120 - 2 - "Выполнил Хаиров Даниэль Равильевич".Length) / 2 + (120 - 2 - "Выполнил Хаиров Даниэль Равильевич".Length) % 2; i++)
            {
                Console.Write(" ");
            }
            Console.Write("║");
